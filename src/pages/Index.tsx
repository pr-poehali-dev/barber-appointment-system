...
const CONGRATS_PARAGRAPHS = [
  ...
  'Я хочу, чтобы ты знала: что бы ни происходило, в каких бы обстоятельствах ты ни оказалась, ты всегда можешь обратиться ко мне. Я не обещаю невозможного, но обещаю, что сделаю всё возможное, чтобы помочь тебе.',
  'С днём рождения. Пусть рядом будут люди, которые берегут твою улыбку так же, как ты бережёшь других. И пусть в твоей жизни будет как можно больше поводов чувствовать себя счастливой.',
];
