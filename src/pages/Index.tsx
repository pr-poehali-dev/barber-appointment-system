...
const CONGRATS_PARAGRAPHS = [
  ...
  'Меня всегда восхищало твоё умение оставаться собой при любых обстоятельствах. В тебе удивительным образом сочетаются доброта, забота, искренность и тот самый колючий характер, который заставляет меня улыбаться. И именно это делает тебя настоящей - живой, непохожей на других и по-особенному красивой.',
  ...
  'Я хочу, чтобы ты знала: что бы ни происходило, в каких бы обстоятельствах ты ни оказалась, ты всегда можешь быть уверена, что я рядом, я на твоей стороне. Я не обещаю невозможного, но обещаю, что сделаю всё, что в моих силах, чтобы помочь тебе. С днём рождения, Таня ❤️',
];
